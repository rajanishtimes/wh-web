...
{	
	...
	public function getscriptandhtml($city, $id, $url){
		...
		googletag.defineSlot('".$url."', [[310, 457], [350, 497],[274, 427],[230, 377],[220, 367],[350, 497], [470, 617],[329, 477],[295, 442],[290, 437],[365, 513],[365, 513]], '".$id."').defineSizeMapping(mappingLeaderboard).addService(googletag.pubads());
