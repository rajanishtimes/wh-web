	...
	<div class="container">
		<div class="row">
					...
					{% for key, images in contentdetail['images'] %}
						<li class="item">
							<a href="{{feeds.makeurl(baseUrl, images['uri'])}}" class="swipebox" title="{{contentdetail['title']}}">
								{{feeds.getimage(baseUrl, images['uri'], 931, 520, contentdetail['title'], '', '', 'img-detail', key+1, 'banner')}} 
							</a>
						</li>
					{% endfor  %}
			...
			<div class="content-container">
				<div class="stickyheader col-sm-2 col-md-2">
					&nbsp;
				...
				<div class="col-sm-6 col-md-7">
					<?php if(!empty($contentdetail['summary'])){ ?>
						<div class="summary detail"><p>{{contentdetail['summary']}}</p></div>
					<?php } ?>
					<div class="detail">
