			...
			<div class="col-sm-12 col-md-12">
				<div class="contentarea">
					...
					<?php if(!empty($contentdetail['published_date'])){ ?>
						<div class="text-center published" data-time="<?php echo date('j-M-Y H:i:s', strtotime($contentdetail['published_date'])); ?>">Published {{elements.friendlyTime(contentdetail['published_date'])}}</div>
					<?php } ?>
