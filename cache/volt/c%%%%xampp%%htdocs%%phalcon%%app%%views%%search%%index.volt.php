...
<?php if($allfeedslist['meta']['match_count'] > ($start*$limit)){ ?>
	<div class="btn btn-primary" onclick="view_feed_with_ajax('<?php echo $mainurl; ?>', '<?php echo $start; ?>', '<?php echo $limit; ?>', '<?php echo $parentid; ?>', '<?php echo $searchkeyword; ?>', '<?php echo $tags; ?>', '<?php echo $bydate; ?>')">Load More</div>
<?php }?>
<?php }else{ ?>
