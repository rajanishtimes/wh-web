		...
		<div class="container">
			<div class="row">
				<div class="search-box">
					<?php echo $this->tag->form(array('search/index/', 'id' => 'searchForm', 'onbeforesubmit' => 'return false')); ?>
							<div class="input-group">
								...
								<?php echo $searchform->render('search', array('class' => 'form-control', 'id' => 'searchtextinput', 'placeholder' => 'Search...')); ?>
