...
<head>
	...
	<!-- CSS start here -->
	<link rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>homepages/css/bootstrap.min.css" media="screen">
	<link rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>homepages/css/styles.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>homepages/css/font-awesome.css">
	<link rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>homepages/css/animate.css" />
	<!-- CSS end here -->
...
<!-- Contact end here --> 
		...
		<script type="text/javascript" src="<?php echo $baseUrl; ?>homepages/js/jquery.js"></script> 
		<script type="text/javascript" src="<?php echo $baseUrl; ?>homepages/js/bootstrap.min.js"></script> 
		<script src="<?php echo $baseUrl; ?>homepages/js/jquery.validate.min.js"></script>
		<script src="<?php echo $baseUrl; ?>homepages/js/modernizr.js"></script> 
		<script type="text/javascript" src="<?php echo $baseUrl; ?>homepages/js/appear.js"></script> 		
		<script src="<?php echo $baseUrl; ?>homepages/js/jquery.knob.js"></script>
		<script src="<?php echo $baseUrl; ?>homepages/js/jquery.ccountdown.js"></script>
		<script src="<?php echo $baseUrl; ?>homepages/js/init.js"></script>
		<script src="<?php echo $baseUrl; ?>homepages/js/general.js"></script>
