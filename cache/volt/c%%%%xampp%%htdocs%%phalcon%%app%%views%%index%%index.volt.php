...
<head>
	...
	<title>WhatsHot Coming Soon</title>
	
    <link name="author" href="humans.txt" />
    <meta name="description" content="Coming soon, WhatsHot ">
	<meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0" />
	<!-- CSS start here -->
	<link rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>homepage/css/bootstrap.min.css" media="screen">
	<link rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>homepage/css/styles.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>homepage/css/font-awesome.css">
	<link rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>homepage/css/animate.css" />
	<!-- CSS end here -->
...
<!-- Contact Icon end here -->
	...
	<section class="container main-wrapper">
		...
		<section id="logo" class="fade-down">
			<a href="#" title="Coming soon WhatsHot">
            		<!--
				<img src="img/whatshot-logo.png" alt="Coming Soon WhatsHot">
			-->
            </a>
		</section>
		<!-- Logo end here -->
		...
		<section class="slogan fade-down">
			<h1>Under construction. We`ll be here soon with our new awesome site, subscribe to be notified.</h1>			
		</section>
		<!-- Slogan end here -->
		...
		<footer class="fade-down">        
			<p class="footer-text">&copy; 2014-2015, All Rights Reserved.</p>
		</footer>
		<!-- Footer end here -->
	</section>
<!-- About start here -->
...
<!-- Contact end here --> 
		...
		<script type="text/javascript" src="<?php echo $baseUrl; ?>homepage/js/jquery.js"></script> 
		<script type="text/javascript" src="<?php echo $baseUrl; ?>homepage/js/bootstrap.min.js"></script> 
		<script src="<?php echo $baseUrl; ?>homepage/<?php echo $baseUrl; ?>homepage/js/jquery.validate.min.js"></script>
		<script src="<?php echo $baseUrl; ?>homepage/js/modernizr.js"></script> 
		<script type="text/javascript" src="<?php echo $baseUrl; ?>homepage/js/appear.js"></script> 		
		<script src="<?php echo $baseUrl; ?>homepage/js/jquery.knob.js"></script>
		<script src="<?php echo $baseUrl; ?>homepage/js/jquery.ccountdown.js"></script>
		<script src="<?php echo $baseUrl; ?>homepage/js/init.js"></script>
		<script src="<?php echo $baseUrl; ?>homepage/js/general.js"></script>
