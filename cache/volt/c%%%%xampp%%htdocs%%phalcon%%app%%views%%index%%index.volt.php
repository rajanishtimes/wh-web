			...
			<div class="section">
				<ul id="feeds-list" class="media-list feed-list">
					<form id="formfeeds" type="POST">
						<input type="hidden" value="<?php echo $allfeeds->meta->match_count; ?>" name="total_feeds">
						<input type="hidden" value="0" name="start_feeds">
						<input type="hidden" value="10" name="limit_feeds">
						<input type="hidden" value="<?php echo $city; ?>" name="city_feeds">
						<input type="hidden" value="<?php echo $getfeedsUrl; ?>" name="url_feeds">
					</form>
